    ...
    class Controller:
        ...
        def buildGrid(self):
            ...
            for letter in gridInfo:
                ...
                if letter!="$" and letter!=self.Bee.keyletter:
                    ...
                    for length in gridInfo[letter]:
                        ...
                        try:
                            text=str(gridInfo[letter][str(lengthIndex+4)])
                        except:
                            text=str(gridInfo[letter]["$"])
                        ...
                        self.display.plex(text,xStart+((lengthIndex+1)*xInterval),yStart+(index*yInterval)+extraY,columnSize,center=True,color=0xFFFFFF,gridUi=True)
                        lengthIndex+=1
            ...
            for length in gridInfo["$"]:
                ...
                try:
                    text=str(gridInfo["$"][str(lengthIndex+4)])
                except:
                ...
                # create the label and add the cell to the gridui
                self.display.plex(text,xStart+((lengthIndex+1)*xInterval)+extraX,yStart+(index*yInterval)+extraY,columnSize,center=True,color=0xFFFFFF,gridUi=True)
                lengthIndex+=1
            ...
            for length in gridInfo[self.Bee.keyletter]:
                # get the text for the label -- the number of words associated with the word length
                try:
                    text=str(gridInfo[self.Bee.keyletter][str(lengthIndex+4)])
                except:
                    text=str(gridInfo[self.Bee.keyletter]["$"])
                ...
                # create the label and add the cell to the gridui
                self.display.plex(text,xStart+((lengthIndex+1)*xInterval),yStart+(3*yInterval)+extraY,columnSize,center=True,color=0xFFFFFF,gridUi=True)
                lengthIndex+=1
